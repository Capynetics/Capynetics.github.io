...
If the object is too complicated to model by hand and you do not have a 3D scanner, photogrammetry is a great option. I have used Meshroom for this, and it works best when the object has lots of texture and surface detail. Stone, wood, and other rough materials are perfect for it. If the object is shiny, metallic, or very smooth, it gets much harder to get a clean result. To illustrate the process, I will show how I used photogrammetry to digitize a statue at my university. It was a good test case because it was large, had a rough surface, and the photos were taken on a cloudy day, which helped avoid harsh shadows.
