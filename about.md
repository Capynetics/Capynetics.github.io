...
My Erdös number is 5, through [William Robson Schwartz](https://mathscinet.ams.org/mathscinet/freetools/collab-dist?source=957160&target=189017).

This blog was developed as my foothold on the internet: a place where I can think, write, and express myself without the mediation of the all-powerful algorithms that control most modern platforms. As a young millennial profoundly shaped by the internet, this blog is my way of contributing back to the community that has significantly influenced my professional growth and personal identity.

If you would like to talk to me, feel free to contact me through one of my social media profiles:
...
P.S.: Yes, that up top is an interactive 3D model of my head, have fun!